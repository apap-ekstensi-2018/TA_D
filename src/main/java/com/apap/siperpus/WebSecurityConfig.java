...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/literatur/tambah","/literatur/ubah","/literatur/delete/**").hasRole(ROLE_STAFF)
		.antMatchers("/literatur/viewall","/index","/literatur/view/**", "/peminjaman/view/**", "/peminjaman/**").hasAnyRole(ROLE_DOSEN, ROLE_MAHASISWA, ROLE_STAFF)
